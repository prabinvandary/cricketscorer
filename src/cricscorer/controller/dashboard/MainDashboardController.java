...
public class MainDashboardController {
    ...
    public Boolean returnDashboardFor(DashboardController dashboardController) throws AssertionError, NoSuchFieldException, NumberFormatException, SQLException {
        System.out.println("Hello welcome to the  cric scorer system.");
        System.out.println("How can i assit you??\n Availale services are:"
                + "\n 1.Add Match Entries   2.Update Entities      3.Create Entities"
                + "     4.View statistics and Details       5.To delete Data\n");
        ...
        Scanner sc = new Scanner(System.in);
        Integer menuNumber = sc.nextInt();
        dashboardSwitching(dashboardController, menuNumber);
        return true;
    }

    private void dashboardSwitching(DashboardController dashboardController, Integer menuNumber) throws AssertionError, NoSuchFieldException, NumberFormatException, SQLException {
        switch (menuNumber) {
            case 1:
                dashboardController.getMatchDashboardController().returnAddMatchDashboard(dashboardController);
                returnDashboardFor(dashboardController);
                break;
            case 2:
                dashboardController.getUpdateEntitiesDashboard().returnUpdateEntitesDashboard(dashboardController);
                returnDashboardFor(dashboardController);
